...
#### Hi, I'm Yeobi 👋 A software engineer who loves clean code and creative solutions.

<!--Body-->
## 🐥 About Me

### 👋 Hi there!
I’m a **senior Computer Engineering student at Hongik University (expected to graduate in 2026)**, passionate about building reliable and well-structured software systems.

- 🎯 Aspiring **Software Engineer** with strong fundamentals and a growth mindset  
- 💻 Interested in **Java**, **Spring Boot**, and building software across **backend and mobile platforms**
...
- **fan_carousel_image_slider** (Flutter)  
  Resolved a touch event issue caused by an animation layer blocking pointer events.  
  Applied `IgnorePointer` and submitted a PR, which was merged.  
  🔗 https://github.com/marjandn/fan_carousel_image_slider/pull/6
...
- **LIKELION Hongik 13th Representative**  
  Led club operations and planned onboarding sessions for beginners.  
  Focused on balancing common sessions and part-based learning.
